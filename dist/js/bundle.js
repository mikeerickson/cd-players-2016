...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Managers = __webpack_require__(178);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactSimpleTable = __webpack_require__(174);
	
	var _reactSimpleTable2 = _interopRequireDefault(_reactSimpleTable);
	
	var _AppUtilsEx = __webpack_require__(176);
	
	var _AppUtilsEx2 = _interopRequireDefault(_AppUtilsEx);
	
	var _AppUtils = __webpack_require__(177);
		...
		_createClass(Teams, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_reactSimpleTable2.default, { className: 'table table-bordered table-striped', columns: this.state.teamHeaders, data: this.state.teamList })
				);
			}
		}]);
	...
	Teams.prototype.getDivision = function (divID) {
		switch (divID) {
			case 'E':
				return 'East';
			case 'W':
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactBootstrapTable = __webpack_require__(180);
